package com.amirovdev.adapterdelegatesnew

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import androidx.recyclerview.widget.RecyclerView
import com.amirovdev.adapterdelegatesnew.adapter.ProductAdapter
 ...
 *
 * When we want to add a new data type:
 *      create a new data type in 'model' package
 *      create a markup file(xml)
 *      create a delegate in 'adapter' package
 *      add created delegate in the list in 'ProductAdapter' class
 *      make changes in data model (add new-created data type in MainActivity -> adapter.items = ...)
 */
